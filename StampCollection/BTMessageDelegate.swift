...
var BTBaseURL : String {
    ...
    let BTBaseURL1 = "http://192.168.1.165.nip.io/BaitTov/bait-tov.com/store/" //= "http://isrstamps.azuresults.com/store/" // in-house site (expandable, not accessible from external locations)
